...
| `workspace`         | `workspace`           | object  | `{ current_dir, project_dir, added_dirs }` — `project_dir` feeds the project-dir widget, `added_dirs` the added-dirs widget, and `current_dir` is the `cwd` fallback                                                                                                                                                                                                                      |

...
| 7   | `feat/agentline-07-theme-engine`               | 5.4, 5.6           | `src/theme/`, ten shipped themes under `themes/`                                                                                                                             | —                  | 6          | Y             |
...
| 24  | `feat/agentline-24-accessibility-gates`        | 1.2 N8, 11.2 G16   | `--no-color`, `--no-unicode`, `--ascii` matrix                                                                                                                               | 16                 | 8          | Y             |

...
import type { WidgetFamily } from "../../widgets/families/catalog.js";
...
/**
 * Bound on the per-direction (past, future) undo stack. The editor takes
 * a fresh snapshot per line-mutating reduction; 64 entries is enough
 * headroom for an interactive editing session while keeping memory and
 * the immutable-spread cost predictable.
 */
...
export const EMPTY_HISTORY: EditorHistory = Object.freeze({
  past: Object.freeze([]) as readonly EditorHistoryEntry[],
  future: Object.freeze([]) as readonly EditorHistoryEntry[],
});

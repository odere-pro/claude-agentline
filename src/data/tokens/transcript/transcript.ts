...
import { FIVE_HOURS_MS } from "../../../core/lib/time.js";

/**
 * Read cap shared with the editor's transcript-discovery path so neither
 * side slurps a multi-GB JSONL into memory. Kept here because this file
 * is the canonical reader; `preview-discovery.ts` mirrors it via import.
 */

...
import { mergeAll } from "../merge/merge.js";
import { envLayer } from "../env/env.js";
import { resolveConfigPaths, type ConfigPaths } from "../paths/paths.js";
...
async function readJsonIfExists(path: string): Promise<unknown> {
  try {
    ...
    return stripPrototypeKeys(JSON.parse(text));
  } catch (err) {
